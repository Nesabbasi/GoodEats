...
#ifdef _WIN32
const std::string system_removeFile = "del ";
const std::string system_terminalProgramStart = "";
const std::string system_makeDirectory = "mkdir ";
const std::string system_slash = "\\";
const std::string system_fileExtention = ".exe";
#else
const std::string system_removeFile = "rm -f ";
const std::string system_terminalProgramStart = "./";
const std::string system_makeDirectory = "mkdir -p ";
const std::string system_slash = "/";
const std::string system_fileExtention = ".o";
#endif
